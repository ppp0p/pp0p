const  RYANDI = 'AMPIBI'; // Nama Bot Whatsapp
const instagram = ':https://www.instagram.com/ryandi_maulana_r'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6285654871764'; // Nomor whatsapplu cok
const aktif = 'Sehabis gue Col*'; // Kapan bot lu aktif
const groupwa = 'p'; // OFFICIAL GRUP LU 1
const youtube = 'gue gak punya tolil'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Ryandi Maulana Rahman\n' // full name
            + 'ORG:p  Ryandi Bot;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=6285654871764:+62 856-5487-1764\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.sendMessage(id, 'Aku BOT nya RYANDI' ,MessageType.text);
}
else if (text == 'wenda'){
